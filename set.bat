...
FOR /F "tokens=1,2 delims==" %%A IN (dx.properties) DO (
    ...
    IF "%%A"=="DX_DOCKER_IMAGE_DESIGN_STUDIO" SET DX_DOCKER_IMAGE_DESIGN_STUDIO=%%B
    IF "%%A"=="DX_DOCKER_IMAGE_HAPROXY" SET DX_DOCKER_IMAGE_HAPROXY=%%B
    IF "%%A"=="DX_DOCKER_IMAGE_PREREQS_CHECKER" SET DX_DOCKER_IMAGE_PREREQS_CHECKER=%%B
)
...
SET DX_DOCKER_IMAGE_DS=%DX_DOCKER_IMAGE_DESIGN_STUDIO%
SET DX_DOCKER_IMAGE_HAPROXY=%DX_DOCKER_IMAGE_HAPROXY%
SET DX_DOCKER_IMAGE_PREREQS_CHECKER=%DX_DOCKER_IMAGE_PREREQS_CHECKER%
